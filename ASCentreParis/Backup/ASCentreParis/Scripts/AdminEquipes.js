 ...
 function initTable() {
	   ...
	   var filtres = getFiltres();
        ...
        return $('#table_id').dataTable({
            ...
            "ajax": {
                "url": '/Administration/RechercheEquipesAjax',
                "type": "POST",
	        ...
	        "columns": [
                ...
                },
                 {
                    "mRender": function (data, type, row) {
                        ...
                        render += "<label id='lblLibelle' class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
	             ...
	             ,
                {
                    "mRender": function (data, type, row) {
                        var render = '';
                            ...
                            render += '	onclick="javascript:ouvrirFormulaireCreation(\'GererEquipe\',\'Administration\','+row.Id+')"';
                            render += '	>';
                            render += '	<img src="../resources/img/pencil.png" title="Modifier l\'élément"/>';
                            render += '</a>';
                            render += ' ';
                            render += '<a class="actionButtons" href="#" style="margin-left:13px;"';
                            render += '	onclick="javascript:supprimerElement(\'SupprimerEquipe\',\'Administration\','+row.Id+',\''+row.Libelle.replace("'"," ")+'\');"';
                            render += '	>';
