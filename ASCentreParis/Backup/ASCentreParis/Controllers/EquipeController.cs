...
namespace ASCentreParis.Controllers
{
    ...
    {
		/// <summary>
		/// Affichers the equipes.
		/// </summary>
		/// <returns>The equipes.</returns>
        public ActionResult AfficherEquipes()
        {
            return View ("~/Views/Equipe/Equipe.cshtml");
        }
		...
		public ActionResult AfficherEquipe(int idEquipe)
		{
			...
			try
			{
				model = Business.EquipeBLL.getInformationsEquipe(idEquipe);
				//model.Commentaire=Commons.Utils.
