...
function initTable() {
	   var filtres = getFiltres();
        ...
        return $('#table_id').dataTable({
            ...
            "ajax": {
                "url": '/Administration/RechercheCommentairesAjax',
                "type": "POST",
	        ...
	        "columns": [
	           ...
	           ,
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        var texte = '';
                        if( row.Utilisateur ) {
                            texte = row.Utilisateur;
                        }

                        render += "<label id='lblUtilisateur'  class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
		           ...
		           ,
                {
                    "mRender": function (data, type, row) {
                        ...
                        var texte = '';
                        if( row.LibelleActualite ) {
                            texte = row.LibelleActualite;
                        }

                        render += "<label id='lblLibelleActualite'  class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
                    "sClass": "td-align-left"
...

	             {
                    "mRender": function (data, type, row) {
                        ...
                        var texte = '';
                        if( row.LibelleDocument) {
                            texte = row.LibelleDocument;
						}

	                    render += "<label id='lblLibelleDocument' class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
                    "sClass": "td-align-left"
		            ...
		            ,
                {
                    "mRender": function (data, type, row) {
                        var render = '';
                            ...
                            render += '	onclick="javascript:supprimerElement(\'SupprimerCommentaire\',\'Administration\','+row.Id+',\'\');"';
                            render += '	>';
