...
function initTable() {
	   var filtres = getFiltres();
        ...
        return $('#table_id').dataTable({
            ...
            "ajax": {
                "url": '/Administration/RechercheDocumentsAjax',
                "type": "POST",
		        ...
		        ,
		            ...
		            ,
	             {
                    "mRender": function (data, type, row) {
                        ...
                        var texte = '';
                        if( row.LibelleCategorieDocumentIHM ) {
                            texte = row.LibelleCategorieDocumentIHM;
                        }

                        render += "<label id='lblCategorieDocument' class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
                    "sClass": "td-align-left"
				     ...
				     ,
	             {
                    "mRender": function (data, type, row) {
                        ...
                        render += "<label id='lblOrdre' class='notEditable' style='font-weight: normal;'>" + texte + "</label>";
                        return render;
                    },
                    "orderable": true,
                    "sClass": "td-align-right"
	             ...
	             ,
                {
                    "mRender": function (data, type, row) {
                        var render = '';
                            ...
                            render += '	onclick="javascript:ouvrirFormulaireCreation(\'GererDocument\',\'Administration\','+row.Id+')"';
                            render += '	>';
                            render += '	<img src="../resources/img/pencil.png" title="Modifier l\'élément"/>';
                            render += '</a>';
                            render += ' ';
                            render += '<a class="actionButtons" href="#" style="margin-left:8px;"';
                            render += '	onclick="javascript:supprimerElement(\'SupprimerDocument\',\'Administration\','+row.Id+',\''+row.Titre.replace("'"," ")+'\');"';
                            render += '	>';
